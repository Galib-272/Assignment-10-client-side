...
export default function AllTicketsPage() {
  ...
  const masterTickets = [
    ...
    {
      _id: "t_6",
      title: "Silk City Shovon Chair (Dhaka - Rajshahi)",
      image:
        "https://images.unsplash.com/photo-1474487548417-781cb71495f3?auto=format&fit=crop&q=80&w=600",
      price: 350,
      transportType: "Train",
  ...
  const filteredTickets = masterTickets
    .filter((ticket) => {
      ...
      const matchesTransport =
        ...
        ticket.transportType === selectedTransport;
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 min-h-screen">
      ...
      <div className="border-b border-gray-200 pb-6 dark:border-gray-800 mb-8">
        ...
        <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
          Enter your terminal origins and destinations to find exact route
          listings.
        </p>
      </div>
      ...
      {filteredTickets.length > 0 ? (
        ...
        <div className="text-center py-20 border border-dashed rounded-xl border-gray-200 dark:border-gray-800">
          <p className="text-gray-500 dark:text-gray-400 font-medium">
            No routes connect those locations with your current options.
          </p>
          <button
            onClick={() => {
              setSearchFrom("");
