...
export default function TicketDetailsPage({ params: paramsPromise }) {
  ...
  const inventoryPool = [
    ...
    },
    {
      ...
      from: "Dhaka",
      to: "Sylhet",
      perks: ["Business Cabin", "Premium Hot Meal", "Extra Baggage 30KG"],
    ...
    },
    {
      ...
      from: "Dhaka",
      to: "Barisal",
      perks: ["VIP Double Bed", "Dinner Included", "Attached Bath"],
      vendorName: "Manami Launch Fleet",
      departure: "09:00 PM",
    },
    {
      _id: "adv_5",
      ...
      from: "Dhaka",
      to: "Rajshahi",
      perks: ["Non-AC Ergonomic seats", "Mineral Water"],
  ...
  const ticket =
    inventoryPool.find((item) => item._id === ticketId) || inventoryPool[0];
  ...
  const incrementQty = () => {
    if (purchaseQty < ticket.quantity) setPurchaseQty((prev) => prev + 1);
  };
  const decrementQty = () => {
    if (purchaseQty > 1) setPurchaseQty((prev) => prev - 1);
  };
  ...
  const handleBookingSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      alert(
        `Booking Successful! Total: ৳${ticket.price * purchaseQty}. Head to Dashboard to pay.`,
      );
    }, 1200);
  };
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12 min-h-screen">
      ...
      <Link
        href="/tickets"
        className="inline-flex items-center text-sm font-semibold text-emerald-600 hover:text-emerald-500 mb-6 transition"
      >
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-wrap gap-2">
                {ticket.perks?.map((perk, idx) => (
                  <span
                    key={idx}
                    className="inline-flex items-center rounded bg-gray-100 dark:bg-gray-800 px-3 py-1 text-xs font-medium text-gray-800 dark:text-gray-200"
                  >
                    ✨ {perk}
                  </span>
                ))}
            ...
            <div className="flex items-center gap-4 bg-gray-50 dark:bg-gray-900 p-3 rounded-xl mb-4">
              ...
              <div className="flex items-center border border-gray-300 dark:border-gray-700 rounded bg-white dark:bg-gray-950">
                <button
                  ...
                  className="px-3 py-1 text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800 font-bold transition"
                >
                  -
                </button>
                <span className="px-4 py-1 text-sm font-bold text-gray-900 dark:text-gray-100 w-12 text-center">
                  {purchaseQty}
                </span>
                <button
              ...
              <span className="ml-auto text-xs font-semibold text-gray-400">
                Subtotal:{" "}
                <b className="text-sm font-bold text-gray-900 dark:text-gray-200">
                  ৳{ticket.price * purchaseQty}
                </b>
              </span>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="w-full max-w-md bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-2xl relative animate-in fade-in zoom-in-95 duration-200">
            ...
            <p className="text-xs text-gray-400 mb-6">
              Review your seat selections and confirm details to lock this
              ticket item.
            </p>
            ...
            <form onSubmit={handleBookingSubmit} className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                <button
                  ...
                  className="w-1/2 text-center rounded-md border border-gray-300 dark:border-gray-700 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-900 transition"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="w-1/2 text-center rounded-md bg-emerald-600 py-2 text-sm font-bold text-white shadow hover:bg-emerald-500 transition disabled:opacity-50"
                >
