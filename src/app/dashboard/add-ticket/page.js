  ...
  return (
    <div className="max-w-2xl bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 sm:p-8 shadow-sm">
      ...
      <div className="border-b border-gray-100 dark:border-gray-800 pb-4 mb-6">
        <h2 className="text-xl font-extrabold text-gray-900 dark:text-white">Create Fleet Route Listing</h2>
        <p className="text-xs text-gray-400 mt-1">Submit transport seat availability. Listings will be displayed publicly upon validation.</p>
      </div>
      ...
      <form onSubmit={handleCreateTicket} className="space-y-5">
        ...
        {/* Ticket Title Name */}
        <div>
          <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1.5">Route Listing Title</label>
          <input
            type="text"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1.5">From (Terminal Origin)</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1.5">To (Terminal Destination)</label>
            <input
              type="text"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1.5">Transport Type</label>
            <select
              value={transportType}
          ...
          {/* Pricing input unit */}
          <div>
            <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1.5">Price (৳ BDT)</label>
            <input
              type="number"
              placeholder="1200"
              value={price}
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1.5">Available Seats</label>
            <input
              type="number"
              placeholder="36"
              value={quantity}
